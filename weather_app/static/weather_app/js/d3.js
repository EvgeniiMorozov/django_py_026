!function (t, n) {
    ...
    function u(t, n) {
        ...
        if (null == n) for (; ++c < i;) isNaN(e = o(t[c])) || (r = e - u, u += r / ++s, a += r * (e - u)); else for (; ++c < i;) isNaN(e = o(n(t[c], c, t))) || (r = e - u, u += r / ++s, a += r * (e - u));
        if (s > 1) return a / (s - 1)
    }
    ...
    function x(t, n) {
        ...
        if (null == n) for (; ++u < i;) isNaN(e = o(t[u])) ? --a : r += e; else for (; ++u < i;) isNaN(e = o(n(t[u], u, t))) ? --a : r += e;
        if (a) return r / a
    }

    function b(t, e) {
        var r, i = [], u = t.length, a = -1;
        if (null == e) for (; ++a < u;) isNaN(r = o(t[a])) || i.push(r); else for (; ++a < u;) isNaN(r = o(e(t[a], a, t))) || i.push(r);
        return _(i.sort(n), .5)
    }
    ...
    function sn() {
        function t() {
            var t, s, f = +n.apply(this, arguments), l = +e.apply(this, arguments), h = o.apply(this, arguments) - gv,
                p = u.apply(this, arguments) - gv, d = Math.abs(p - h), v = p > h;
            if (c || (c = t = Tt()), l < f && (s = l, l = f, f = s), l > _v) if (d > mv - _v) c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > _v && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v)); else {
                var _, y, g = h, m = p, x = h, b = p, w = d, M = d, T = a.apply(this, arguments) / 2,
                    k = T > _v && (i ? +i.apply(this, arguments) : Math.sqrt(f * f + l * l)),
                    N = Math.min(Math.abs(l - f) / 2, +r.apply(this, arguments)), S = N, A = N;
                if (k > _v) {
                ...
                if (N > _v) {
                    ...
                    if (d < yv) {
                        var F = w > _v ? an(z, P, D, O, R, U, q, L) : [q, L], I = z - F[0], Y = P - F[1], B = R - F[0],
                            j = U - F[1],
    ...
    function gn() {
        ...
        var n = yn, e = _n, r = null, i = Kt(0), o = Kt(mv), u = Kt(0);
        return t.value = function (e) {
            return arguments.length ? (n = "function" == typeof e ? e : Kt(+e), t) : n
    ...
    function Mn() {
        var t = vn().curve(xv), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    function Pe(t) {
        ...
        var e = Oe(t.r), r = Oe(t.g), i = Oe(t.b), o = Re((.4124564 * e + .3575761 * r + .1804375 * i) / c_),
    ...
    function Be(t) {
        ...
        t instanceof Ne || (t = Te(t));
        var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (w_ * r + x_ * n - b_ * e) / (w_ + x_ - b_), o = r - i,
            u = (m_ * (e - i) - y_ * o) / g_, a = Math.sqrt(u * u + o * o) / (m_ * i * (1 - i)),
    ...
    function ar(t, n) {
        var e, r, i, o = C_.lastIndex = z_.lastIndex = 0, u = -1, a = [], c = [];
        for (t += "", n += ""; (e = C_.exec(t)) && (r = z_.exec(n));) (i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
            i: u,
            x: rr(e, r)
        })), o = z_.lastIndex;
    ...
    function yr(t, n) {
        ...
        if (h < F_) r = Math.log(s / u) / U_, e = function (t) {
            ...
            var p = Math.sqrt(h), d = (s * s - u * u + O_ * h) / (2 * u * D_ * p),
                v = (s * s - u * u - O_ * h) / (2 * s * D_ * p), _ = Math.log(Math.sqrt(d * d + 1) - d),
                y = Math.log(Math.sqrt(v * v + 1) - v);
            r = (y - _) / U_, e = function (t) {
                var n = t * r, e = dr(_), a = u / (D_ * p) * (e * _r(U_ * n + _) - vr(_));
    ...
    function br(t) {
        return function n(e) {
            function r(n, r) {
                var i = t((n = je(n)).h, (r = je(r)).h), o = Ke(n.s, r.s), u = Ke(n.l, r.l),
    ...
    function Pr(t, n) {
        ...
        var r, i, o, u, a = Mr("beforesend", "progress", "load", "error"), c = q(), s = new XMLHttpRequest, f = null,
            l = null, h = 0;
    ...
    function ei(t, n) {
        var e = Qr(t, n);
        if (!e) return t + "";
        var r = e[0], i = e[1], o = i - (Tg = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1, u = r.length;
    ...
    function ai(t) {
        function n(t) {
            function n(t) {
                ...
                if ("c" === p) m = _(t) + m, t = ""; else {
                    ...
                    if (g = (x ? "(" === a ? a : "-" : "-" === a || "(" === a ? "" : a) + g, m = m + ("s" === p ? Eg[8 + Tg / 3] : "") + (x && "(" === a ? ")" : ""), y) for (n = -1, i = t.length; ++n < i;) if (c = t.charCodeAt(n), 48 > c || c > 57) {
            ...
            var e = t.fill, u = t.align, a = t.sign, c = t.symbol, s = t.zero, f = t.width, l = t.comma,
                ...
                v = "$" === c ? i[1] : /[%p]/.test(p) ? "%" : "", _ = Ng[p], y = !p || /[defgprs%]/.test(p);
        ...
        function e(t, e) {
            var r = n((t = ii(t), t.type = "f", t)), i = 3 * Math.max(-8, Math.min(8, Math.floor(Kr(e) / 3))),
                o = Math.pow(10, -i), u = Eg[8 + i / 3];
            return function (t) {
                return r(o * t) + u
            }
        }
    ...
    function vi(t) {
        ...
        var w = t.dateTime, M = t.date, T = t.time, k = t.periods, N = t.days, S = t.shortDays, A = t.months,
            E = t.shortMonths, C = gi(k), z = mi(k), P = gi(N), q = mi(N), L = gi(S), R = mi(S), U = gi(A), D = mi(A),
            O = gi(E), F = mi(E), I = {
                a: h,
                A: p,
                b: d,
    ...
    function po() {
        ...
        var n, e, r = ho().unknown(void 0), i = r.domain, o = r.range, u = [0, 1], a = !1, c = 0, s = 0, f = .5;
    ...
    function Do() {
        ...
        var e = ko(zo, Po).domain([1, 10]), r = e.domain, i = 10, o = Ro(10), u = Lo(10);
    ...
    function Vo(t, n, r, i, o, u, a, c, s) {
        ...
        var h = ko(mo, rr), d = h.invert, v = h.domain, _ = s(".%L"), y = s(":%S"), g = s("%I:%M"), m = s("%I %p"),
    ...
    function Au(t, n) {
        ...
        var e = n ? Su : Nu, r = this._parents, i = this._groups;
    ...
    function rc(t, n) {
        var e = Ko(t), r = "transform" === e ? R_ : Ga;
    ...
    function kc(t, n) {
        var e, r, i;
        return function () {
            var o = Wu(this).getComputedStyle(this, null), u = o.getPropertyValue(t),
    ...
    function Rc() {
        for (var t = this._name, n = this._id, e = Oc(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) if (u = a[s]) {
            var f = Ba(u, n);
            Fa(u, t, e, s, a, {time: f.time + f.delay + f.duration, delay: 0, duration: f.duration, ease: f.ease})
        }
    ...
    function Fc(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);) if (!(t = t.parentNode)) return Cm.time = Or(), Cm;
        return e
    }
    ...
    function Yc(t, n) {
        ...
        if (i) {
            n = null == n ? null : n + "";
            for (r in i) if ((e = i[r]).state > wm && e.name === n) return new Uc([[t]], zm, n, (+r))
        }
        return null
    }
    ...
    function Wc(t, n) {
        function e(e) {
            var s, f = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i,
                l = null == o ? n.tickFormat ? n.tickFormat.apply(n, r) : Bc : o, h = Math.max(u, 0) + c,
                p = t === qm || t === Rm ? jc : Hc, d = n.range(), v = d[0] + .5, _ = d[d.length - 1] + .5,
                y = (n.bandwidth ? Xc : Bc)(n.copy()), g = e.selection ? e.selection() : e,
                m = g.selectAll(".domain").data([null]), x = g.selectAll(".tick").data(f, n).order(), b = x.exit(),
                w = x.enter().append("g").attr("class", "tick"), M = x.select("line"), T = x.select("text"),
                k = t === qm || t === Um ? -1 : 1, N = t === Um || t === Lm ? (s = "x", "y") : (s = "y", "x");
    ...
    function ys(t, n) {
        var e, r, i, o, u, a = new ws(t), c = +t.value && (a.value = t.value), s = [a];
    ...
    function Cs(t, n, e) {
        var r = t.x, i = t.y, o = t.r, u = n.x, a = n.y, c = n.r, s = e.x, f = e.y, l = e.r, h = 2 * (r - u),
            ...
            k = w * w + T * T - 1, N = 2 * (b * w + M * T + o), S = b * b + M * M - o * o,
    ...
    function uf(t) {
        for (var n, e, r, i, o, u = new of(t, 0), a = [u]; n = a.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new of(r[i], i)), e.parent = n;
    ...
    function ff() {
        ...
        var e = Bm, r = !1, i = 1, o = 1, u = [0], a = Fs, c = Fs, s = Fs, f = Fs, l = Fs;
        return t.round = function (n) {
    ...
    function Uf() {
        ...
        function c(e, r, i, o, u) {
            ...
            if (lu(new Pf(n, "beforestart", a, e, _, f[0], f[1], 0, 0, l), function () {
                ...
                lu(new Pf(n, t, a, e, p, f[0] + c, f[1] + s, f[0] - v[0], f[1] - v[1], l), l.apply, l, [t, o, u])
            }
        }
    ...
    function Jf(t) {
        return $m[t.index] = {site: t, halfedges: []}
    }
    ...
    function nl() {
        for (var t, n, e, r, i = 0, o = $m.length; i < o; ++i) if ((t = $m[i]) && (r = (n = t.halfedges).length)) {
    ...
    function el(t, n, e, r) {
        var i, o, u, a, c, s, f, l, h, p, d, v, _ = $m.length, y = !0;
        for (i = 0; i < _; ++i) if (o = $m[i]) {
        ...
        if (n && e) {
            ...
            if (r !== o) {
                ...
                if (!(h >= -tx)) {
                    ...
                    for (var g = null, m = Zm._; m;) if (y.y < m.y || y.y === m.y && y.x <= m.x) {
                        if (!m.L) {
                            g = m.P;
                            break
                        }
    ...
    function fl(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = Wm._; a;) if (r = ll(a, u) - o, r > Km) a = a.L; else {
            if (i = o - hl(a, u), !(i > Km)) {
    ...
    function vl(t, n) {
        ...
        for (Gm = [], $m = new Array(t.length), Wm = new If, Zm = new If; ;) if (i = Vm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (fl(o), e = o[0], r = o[1]), o = t.pop(); else {
            if (!i) break;
            sl(i.arc)
        }
        if (nl(), n) {
    ...
    function Nl() {
        ...
        function u(t, n, e) {
            t.on("start.zoom", function () {
                ...
                var t = this, r = arguments, i = a(t, r), u = g.apply(t, r), c = e || o(u),
        ...
        function a(t, n) {
            for (var e, r = 0, i = N.length; r < i; ++r) if ((e = N[r]).that === t) return e;
            return new c(t, n)
        }
        ...
        function f() {
            ...
            if (!_ && y.apply(this, arguments)) {
                var o = a(this, arguments), u = Ra(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0),
                    c = du(this);
        ...
        function l() {
            if (y.apply(this, arguments)) {
                var o = this.__zoom, a = du(this), c = o.invert(a), s = o.k * (t.event.shiftKey ? .5 : 2),
        ...
        function p() {
            ...
            if (o = s.that.__zoom, s.touch1) {
                var h = s.touch0[0], p = s.touch0[1], d = s.touch1[0], _ = s.touch1[1],
        ...
        var v, _, y = Ml, g = Tl, m = 0, x = 1 / 0, b = -x, w = x, M = b, T = w, k = 250, N = [],
            S = Mr("start", "zoom", "end"), A = 500, E = 150;
        return n.transform = function (t, n) {
            ...
            n.transform(t, function () {
                var t = g.apply(this, arguments), n = this.__zoom, a = o(t), c = n.invert(a),
    ...
    function Il(n) {
        ...
        function u() {
            ...
            if (f.apply(this, arguments)) {
                var l, h, p, d, v, _, y, g, m, x, b, w, M, T = this, k = t.event.target.__data__.type,
                    N = "selection" === (t.event.metaKey ? k = "overlay" : k) ? ex : t.event.altKey ? ox : ix,
                    S = n === ax ? null : hx[k], A = n === ux ? null : px[k], E = Ll(T), C = E.extent, z = E.selection,
                    P = C[0][0], q = C[0][1], L = C[1][0], R = C[1][1], U = S && A && t.event.shiftKey, D = du(T),
                ...
                var I = Ra(T).attr("pointer-events", "none"), Y = I.selectAll(".overlay").attr("cursor", sx[k]);
        ...
        return e.move = function (t, e) {
            t.selection ? t.on("start.brush", function () {
                ...
                var o = this, u = o.__brush, a = i(o, arguments), c = u.selection,
                    s = n.input("function" == typeof e ? e.apply(this, arguments) : e, u.extent), f = cr(c, s);
                return c && s ? t : t(1)
            }) : t.each(function () {
    ...
    function Bl() {
        function t(t) {
            var o, u, a, c, s, f, h = t.length, p = [], d = l(h), v = [], _ = [], y = _.groups = new Array(h),
                g = new Array(h * h);
            for (o = 0, s = -1; ++s < h;) {
            ...
            for (e && d.sort(function (t, n) {
                ...
                for (a = u, f = -1; ++f < h;) {
                    ...
                    g[x * h + m] = {index: m, subindex: x, startAngle: w, endAngle: M, value: b}
                }
                y[m] = {index: m, startAngle: a, endAngle: u, value: p[m]}, u += c
            }
            for (s = -1; ++s < h;) for (f = s - 1; ++f < h;) {
                var T = g[f * h + s], k = g[s * h + f];
                (T.value || k.value) && _.push(T.value < k.value ? {source: k, target: T} : {source: T, target: k})
            }
            return i ? _.sort(i) : _
        }
        ...
        return t.padAngle = function (e) {
            ...
            return arguments.length ? (null == n ? i = null : (i = Yl(n))._ = n,
                t) : i && i._
        }, t
    }
    ...
    function Zl() {
        function t() {
            var t, a = xx.call(arguments), c = n.apply(this, a), s = e.apply(this, a),
                f = +r.apply(this, (a[0] = c, a)), l = i.apply(this, a) - yx, h = o.apply(this, a) - yx, p = f * dx(l),
                d = f * vx(l), v = +r.apply(this, (a[0] = s, a)), _ = i.apply(this, a) - yx, y = o.apply(this, a) - yx;
    ...
    function fh(t, n) {
        t *= sb, n *= sb, n = n / 2 + ub;
        var e = t - kx, r = e >= 0 ? 1 : -1, i = r * e, o = pb(n), u = gb(n), a = Sx * u, c = Nx * o + a * pb(i),
            s = a * r * gb(i);
    ...
    function xh(t, n) {
        var e = ph([t * sb, n * sb]);
        if (Rx) {
            var r = vh(Rx, e), i = [r[1], -r[0], 0], o = vh(i, r);
            gh(o), o = hh(o);
            var u, a = t - Px, c = a > 0 ? 1 : -1, s = o[0] * cb * c, f = fb(a) > 180;
    ...
    function Lh(t, n) {
        t *= sb, n *= sb;
        var e = pb(n), r = e * pb(t), i = e * gb(t), o = gb(n),
    ...
    function Fh(t, n) {
        t *= sb, n *= sb;
        var e = pb(n), r = e * pb(t), i = e * gb(t), o = gb(n), u = Kx * o - tb * i, a = tb * r - Qx * o,
            c = Qx * i - Kx * r, s = xb(u * u + a * a + c * c), f = Qx * r + Kx * i + tb * o, l = s && -Kl(f) / s,
            h = hb(s, f);
    ...
    function Jh() {
        ...
        var e, r, i = Yh([0, 0]), o = Yh(90), u = Yh(6), a = {point: t};
    ...
    function ip(t, n, e, r) {
        ...
        return function (u) {
            ...
            function d(o, u) {
                var a = i(o, u);
                if (_ && y.push([o, u]), k) g = o, m = u, x = a, k = !1, a && (S.lineStart(), S.point(o, u)); else if (a && T) S.point(o, u); else {
            ...
            var v, _, y, g, m, x, b, M, T, k, N, S = u, A = Qh(),
    ...
    function sp(t, n) {
        t *= sb, n *= sb;
        var e = gb(n), r = pb(n), i = fb(t - Ab), o = pb(i), u = gb(i), a = r * u, c = Cb * e - Eb * r * o,
            s = Eb * e + Cb * r * o;
    ...
    function vp(t, n) {
        var e = t[0] * sb, r = t[1] * sb, i = n[0] * sb, o = n[1] * sb, u = pb(r), a = gb(r), c = pb(o), s = gb(o),
            f = u * pb(e), l = u * gb(e), h = c * pb(i), p = c * gb(i), d = 2 * th(xb(nh(o - r) + u * c * nh(i - e))),
            v = gb(d), _ = d ? function (t) {
    ...
    function kp(t, n) {
        var e = t - Db, r = n - Ob, i = xb(e * e + r * r);
    ...
    function Pp() {
        ...
        var u = qp(4.5), a = [], c = {
            point: t, lineStart: r, lineEnd: i, polygonStart: function () {
                c.lineEnd = o
            }, polygonEnd: function () {
    ...
    function Rp(t, n) {
        for (var e = n[0], r = n[1], i = [gb(e), -pb(e), 0], o = 0, u = 0, a = 0, c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + ub, d = gb(p), v = pb(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
            var y = s[_], g = y[0], m = y[1] / 2 + ub, x = gb(m), b = pb(m), w = g - h, M = w >= 0 ? 1 : -1, T = M * w,
                k = T > ib, N = d * x;
    ...
    function Yp(t, n, e, r) {
        var i;
        if (null == t) i = e * ob, r.point(-ib, i), r.point(0, i), r.point(ib, i), r.point(ib, 0), r.point(ib, -i), r.point(0, -i), r.point(-ib, -i), r.point(-ib, 0), r.point(-ib, i); else if (fb(t[0] - n[0]) > eb) {
            var o = t[0] < n[0] ? ib : -ib;
    ...
    function Bp(t, n) {
        ...
        function i(t) {
            ...
            return {
                lineStart: function () {
                    ...
                    var p, d = [l, h], v = r(l, h), _ = c ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? ib : -ib), h) : 0;
                    if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (tp(n, p) || tp(d, p)) && (d[0] += eb, d[1] += eb, v = r(d[0], d[1]))), v !== i) f = 0, v ? (t.lineStart(), p = o(d, n), t.point(p[0], p[1])) : (p = o(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p; else if (s && n && c ^ v) {
                        var y;
        ...
        function o(t, n, e) {
            var r = ph(t), i = ph(n), o = [1, 0, 0], u = vh(r, i), c = dh(u, u), s = u[0], f = c - s * s;
            if (!f) return !e && t;
            ...
            if (!(m < 0)) {
                ...
                var w, M = t[0], T = n[0], k = t[1], N = n[1];
                T < M && (w = M, M = T, T = w);
                var S = T - M, A = fb(S - ib) < eb, E = A || S < eb;
    ...
    function $p(t, n) {
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h, b = a + p, w = c + d, M = xb(x * x + b * b + w * w), T = th(w /= M),
                    k = fb(fb(w) - 1) < eb || fb(o - l) < eb ? (o + l) / 2 : hb(b, x), N = t(k, T), S = N[0], A = N[1],
                    E = S - r, C = A - i, z = g * E - y * C;
    ...
    function ed() {
        ...
        var n, e, r, i, o, u, a = td(), c = Kp().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            s = Kp().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
                point: function (t, n) {
                    u = [t, n]
                }
            };
    ...
    function sd(t) {
        var n, e = Zp(t), r = e.scale, i = e.translate, o = e.clipExtent;
        return e.scale = function (t) {
    ...
    function ld(t, n) {
        ...
        var r = pb(t), i = t === n ? gb(t) : _b(r / pb(n)) / _b(fd(n) / fd(t)), o = r * yb(fd(t), i) / i;
    ...
    function Td() {
        var t = sd(Md), n = t.center, e = t.rotate;
    ...
    var kd = "4.1.1", Nd = e(n), Sd = Nd.right, Ad = Nd.left, Ed = Array.prototype, Cd = Ed.slice, zd = Ed.map,
        Pd = Math.sqrt(50), qd = Math.sqrt(10), Ld = Math.sqrt(2), Rd = "$";
    P.prototype = q.prototype = {
        constructor: P, has: function (t) {
            return Rd + t in this
        }, get: function (t) {
            return this[Rd + t]
        }, set: function (t, n) {
            ...
            var t = [];
            for (var n in this) n[0] === Rd && t.push({key: n.slice(1), value: this[n]});
            return t
        }, size: function () {
            var t = 0;
            ...
            for (var t in this) if (t[0] === Rd) return !1;
            return !0
        }, each: function (t) {
    ...
    F.prototype = I.prototype = {
        constructor: F, has: Ud.has, add: function (t) {
            return t += "", this[Rd + t] = t, this
        }, remove: Ud.remove, clear: Ud.clear, values: Ud.keys, size: Ud.size, empty: Ud.empty, each: Ud.each
    };
    var Dd = 3, Od = function vw(t) {
            function n(n) {
                return Math.pow(n, t)
            }

            return t = +t, n.exponent = vw, n
        }(Dd), Fd = function _w(t) {
            function n(n) {
                return 1 - Math.pow(1 - n, t)
            }

            return t = +t, n.exponent = _w, n
        }(Dd), Id = function yw(t) {
            function n(n) {
                return ((n *= 2) <= 1 ? Math.pow(n, t) : 2 - Math.pow(2 - n, t)) / 2
            }

            return t = +t, n.exponent = yw, n
        }(Dd), Yd = Math.PI, Bd = Yd / 2, jd = 4 / 11, Hd = 6 / 11, Xd = 8 / 11, Vd = .75, Wd = 9 / 11, $d = 10 / 11,
        Zd = .9375, Gd = 21 / 22, Jd = 63 / 64, Qd = 1 / jd / jd, Kd = 1.70158, tv = function gw(t) {
            function n(n) {
                return n * n * ((t + 1) * n - t)
            }

            return t = +t, n.overshoot = gw, n
        }(Kd), nv = function mw(t) {
            function n(n) {
                return --n * n * ((t + 1) * n + t) + 1
            }

            return t = +t, n.overshoot = mw, n
        }(Kd), ev = function xw(t) {
            function n(n) {
                return ((n *= 2) < 1 ? n * n * ((t + 1) * n - t) : (n -= 2) * n * ((t + 1) * n + t) + 2) / 2
            }

            return t = +t, n.overshoot = xw, n
        }(Kd), rv = 2 * Math.PI, iv = 1, ov = .3, uv = function bw(t, n) {
            function e(e) {
                return t * Math.pow(2, 10 * --e) * Math.sin((r - e) / n)
            }

            var r = Math.asin(1 / (t = Math.max(1, t))) * (n /= rv);
            return e.amplitude = function (t) {
                return bw(t, n * rv)
            }, e.period = function (n) {
                return bw(t, n)
            }, e
        }(iv, ov), av = function ww(t, n) {
            function e(e) {
        ...
        }(iv, ov), sv = Math.PI, fv = 2 * sv, lv = 1e-6, hv = fv - lv;
    Mt.prototype = Tt.prototype = {
        constructor: Mt, moveTo: function (t, n) {
            ...
            if (null === this._x1) this._.push("M", this._x1 = t, ",", this._y1 = n); else if (l > lv) if (Math.abs(f * a - c * s) > lv && i) {
                var h = e - o, p = r - u, d = a * a + c * c, v = h * h + p * p, _ = Math.sqrt(d), y = Math.sqrt(l),
                    g = i * Math.tan((sv - Math.acos((d + l - v) / (2 * _ * y))) / 2), m = g / y, x = g / _;
    ...
    Vt.prototype = Qt.prototype = {
        constructor: Vt, defer: function (t) {
    ...
    var _v = 1e-12, yv = Math.PI, gv = yv / 2, mv = 2 * yv;
    fn.prototype = {
        areaStart: function () {
            this._line = 0
        }, areaEnd: function () {
    ...
    var bv = {
        ...
        }, Mv = Math.sqrt(1 / 3), Tv = 2 * Mv, kv = {
            draw: function (t, n) {
                var e = Math.sqrt(n / Tv), r = e * Mv;
                t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
            }
        }, Nv = .8908130915292852, Sv = Math.sin(yv / 10) / Math.sin(7 * yv / 10), Av = Math.sin(mv / 10) * Sv,
        Ev = -Math.cos(mv / 10) * Sv, Cv = {
            draw: function (t, n) {
                var e = Math.sqrt(n * Nv), r = Av * e, i = Ev * e;
                t.moveTo(0, -e), t.lineTo(r, i);
                for (var o = 1; o < 5; ++o) {
                    var u = mv * o / 5, a = Math.cos(u), c = Math.sin(u);
        ...
        }, Lv = -.5, Rv = Math.sqrt(3) / 2, Uv = 1 / Math.sqrt(12), Dv = 3 * (Uv / 2 + 1), Ov = {
            draw: function (t, n) {
                var e = Math.sqrt(n / Dv), r = e / 2, i = e * Uv, o = r, u = e * Uv + e, a = -o, c = u;
    ...
    Sn.prototype = {
        ...
        areaStart: kn, areaEnd: kn, lineStart: function () {
    ...
    var Iv = function Tw(t) {
        function n(n) {
            return 1 === t ? new Sn(n) : new qn(n, t)
        }
    ...
    var Hv = function Aw(t) {
        function n(n) {
            return t ? new Fn(n, t) : new Rn(n, 0)
        }
    ...
    var Xv = function Ew(t) {
        function n(n) {
            return t ? new In(n, t) : new Un(n, 0)
        }
    ...
    Bn.prototype = {
        ...
        areaStart: function () {
            ...
            if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]); else for (var r = te(t), i = te(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
    ...
    var Wv = Array.prototype.slice, $v = .7, Zv = 1 / $v, Gv = /^#([0-9a-f]{3})$/, Jv = /^#([0-9a-f]{6})$/,
    ...
    var o_ = Math.PI / 180, u_ = 180 / Math.PI, a_ = 18, c_ = .95047, s_ = 1, f_ = 1.08883, l_ = 4 / 29, h_ = 6 / 29,
        p_ = 3 * h_ * h_, d_ = h_ * h_ * h_;
    ge(Le, qe, me(xe, {
        brighter: function (t) {
    ...
    var v_ = -.14861, __ = 1.78277, y_ = -.29227, g_ = -.90649, m_ = 1.97294, x_ = m_ * g_, b_ = m_ * __,
        w_ = __ * y_ - g_ * v_;
    ge(He, je, me(xe, {
        brighter: function (t) {
            ...
            var t = isNaN(this.h) ? 0 : (this.h + 120) * o_, n = +this.l, e = isNaN(this.s) ? 0 : this.s * n * (1 - n),
                r = Math.cos(t), i = Math.sin(t);
            return new Ne(255 * (n + e * (v_ * r + __ * i)), 255 * (n + e * (y_ * r + g_ * i)), 255 * (n + e * (m_ * r)), this.opacity)
        }
    }));
    var M_, T_, k_, N_, S_ = function zw(t) {
            function n(t, n) {
                var r = e((t = ke(t)).r, (n = ke(n)).r), i = e(t.g, n.g), o = e(t.b, n.b), u = e(t.opacity, n.opacity);
                return function (n) {
            ...
            var e = Qe(t);
            return n.gamma = zw, n
        }(1), A_ = tr(Ve), E_ = tr(We), C_ = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, z_ = new RegExp(C_.source, "g"),
        P_ = 180 / Math.PI, q_ = {translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1},
        L_ = pr(lr, "px, ", "px)", "deg)"), R_ = pr(hr, ", ", ")", ")"), U_ = Math.SQRT2, D_ = 2, O_ = 4, F_ = 1e-12,
        I_ = gr(Je), Y_ = gr(Ke), B_ = xr(Je), j_ = xr(Ke), H_ = br(Je), X_ = br(Ke), V_ = {
            value: function () {
            }
        };
    Tr.prototype = Mr.prototype = {
        constructor: Tr, on: function (t, n) {
            var e, r = this._, i = kr(t + "", r), o = -1, u = i.length;
            if (!(arguments.length < 2)) {
                if (null != n && "function" != typeof n) throw new Error("invalid callback: " + n);
                for (; ++o < u;) if (e = (t = i[o]).type) r[e] = Sr(r[e], t.name, n); else if (null == n) for (e in r) r[e] = Sr(r[e], t.name, null);
                return this
            }
            for (; ++o < u;) if ((e = (t = i[o]).type) && (e = Nr(r[e], t.name))) return e
        }, copy: function () {
            var t = {}, n = this._;
    ...
    var W_, $_, Z_ = zr(","), G_ = Z_.parse, J_ = Z_.parseRows, Q_ = Z_.format, K_ = Z_.formatRows, ty = zr("\t"),
        ny = ty.parse, ey = ty.parseRows, ry = ty.format, iy = ty.formatRows, oy = Rr("text/html", function (t) {
            ...
            return n
        }), sy = Ur("text/csv", G_), fy = Ur("text/tab-separated-values", ny), ly = 0, hy = 0, py = 0, dy = 1e3, vy = 0,
        _y = 0, yy = 0, gy = "object" == typeof performance && performance.now ? performance : Date,
    ...
    var xy = new Date, by = new Date, wy = Zr(function () {
    }, function (t, n) {
        t.setTime(+t + n)
    }, function (t, n) {
        return n - t
    ...
    var My = wy.range, Ty = 1e3, ky = 6e4, Ny = 36e5, Sy = 864e5, Ay = 6048e5, Ey = Zr(function (t) {
            ...
            return t.getDate() - 1
        }), Uy = Ry.range, Dy = Gr(0), Oy = Gr(1), Fy = Gr(2), Iy = Gr(3), Yy = Gr(4), By = Gr(5), jy = Gr(6),
        Hy = Dy.range, Xy = Oy.range, Vy = Fy.range, Wy = Iy.range, $y = Yy.range, Zy = By.range, Gy = jy.range,
        Jy = Zr(function (t) {
    ...
    var tg = Ky.range, ng = Zr(function (t) {
            t.setUTCSeconds(0, 0)
        }, function (t, n) {
            t.setTime(+t + n * ky)
        }, function (t, n) {
        ...
        }), ug = og.range, ag = Jr(0), cg = Jr(1), sg = Jr(2), fg = Jr(3), lg = Jr(4), hg = Jr(5), pg = Jr(6),
        dg = ag.range, vg = cg.range, _g = sg.range, yg = fg.range, gg = lg.range, mg = hg.range, xg = pg.range,
        bg = Zr(function (t) {
    ...
    var Ag, Eg = ["y", "z", "a", "f", "p", "n", "Âµ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    t.format, t.formatPrefix, ci({decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""]});
    var Cg, zg = {"-": "", _: " ", 0: "0"}, Pg = /^\s*\d+/, qg = /^%/, Lg = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
    ...
    var Rg = "%Y-%m-%dT%H:%M:%S.%LZ", Ug = Date.prototype.toISOString ? fo : t.utcFormat(Rg),
        Dg = +new Date("2000-01-01T00:00:00.000Z") ? lo : t.utcParse(Rg), Og = Array.prototype, Fg = Og.map,
        Ig = Og.slice, Yg = {name: "implicit"}, Bg = [0, 1], jg = 1e3, Hg = 60 * jg, Xg = 60 * Hg, Vg = 24 * Xg,
        Wg = 7 * Vg, $g = 30 * Vg, Zg = 365 * Vg,
        ...
        tm = X_(je(300, .5, 0), je(-240, .5, 1)), nm = X_(je(-100, .75, .35), je(80, 1.5, .8)),
        em = X_(je(260, .75, .35), je(80, 1.5, .8)), rm = je(),
    ...
    if (t.event = null, "undefined" != typeof document) {
        ...
        "onmouseenter" in _m || (vm = {mouseenter: "mouseover", mouseleave: "mouseout"})
    }
    Tu.prototype = {
        constructor: Tu, appendChild: function (t) {
    ...
    var mm = Mr("start", "end", "interrupt"), xm = [], bm = 0, wm = 1, Mm = 2, Tm = 3, km = 4, Nm = 5,
        Sm = La.prototype.constructor, Am = 0, Em = La.prototype;
    ...
    var Cm = {time: null, delay: 0, duration: 250, ease: et};
    La.prototype.interrupt = Xa, La.prototype.transition = Ic;
    var zm = [null], Pm = Array.prototype.slice, qm = 1, Lm = 2, Rm = 3, Um = 4, Dm = 1e-6;
    ...
    var Om = "$", Fm = {depth: -1}, Im = {};
    of.prototype = Object.create(ws.prototype);
    var Ym = (1 + Math.sqrt(5)) / 2, Bm = function Pw(t) {
        ...
        function n(n, e, r, i, o) {
            if ((u = n._squarify) && u.ratio === t) for (var u, a, c, s, f, l = -1, h = u.length, p = n.value; ++l < h;) {
            ...
            } else n._squarify = u = sf(t, n, e, r, i, o), u.ratio = t
        }

        return n.ratio = function (t) {
            return qw((t = +t) > 1 ? t : 1)
        }, n
    }(Ym), Hm = 10, Xm = Math.PI * (3 - Math.sqrt(5));
    Pf.prototype.on = function () {
        var t = this._.on.apply(this._, arguments);
        return t === this._ ? this : t
    }, If.prototype = {
        constructor: If, insert: function (t, n) {
            var e, r, i;
            if (t) {
    ...
    var Vm, Wm, $m, Zm, Gm, Jm = [], Qm = [], Km = 1e-6, tx = 1e-12;
    vl.prototype = {
        constructor: vl, polygons: function () {
            var t = this.edges;
        ...
        constructor: ml, scale: function (t) {
    ...
    var ex = {name: "drag"}, rx = {name: "space"}, ix = {name: "handle"}, ox = {name: "center"}, ux = {
            name: "x", handles: ["e", "w"].map(zl), input: function (t, n) {
                return t && [[t[0], n[0][1]], [t[1], n[1][1]]]
            }, output: function (t) {
                return t && [t[0][0], t[1][0]]
            }
        }, ax = {
            name: "y", handles: ["n", "s"].map(zl), input: function (t, n) {
                return t && [[n[0][0], t[0]], [n[1][0], t[1]]]
            }, output: function (t) {
                return t && [t[0][1], t[1][1]]
            }
        }, cx = {
            name: "xy", handles: ["n", "e", "s", "w", "nw", "ne", "se", "sw"].map(zl), input: function (t) {
                return t
            }, output: function (t) {
                return t
            }
            ...
            se: "nwse-resize",
            sw: "nesw-resize"
        }, fx = {e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se"},
        lx = {n: "s", s: "n", nw: "sw", ne: "se", se: "ne", sw: "nw"},
        hx = {overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1},
        px = {overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1}, dx = Math.cos,
        vx = Math.sin, _x = Math.PI, yx = _x / 2, gx = 2 * _x, mx = Math.max, xx = Array.prototype.slice;
    Jl.prototype = {
        constructor: Jl, reset: function () {
            this.s = this.t = 0
        }, add: function (t) {
    ...
    var bx, wx, Mx, Tx, kx, Nx, Sx, Ax, Ex, Cx, zx, Px, qx, Lx, Rx, Ux, Dx, Ox, Fx, Ix, Yx, Bx, jx, Hx, Xx, Vx, Wx, $x,
        Zx, Gx, Jx, Qx, Kx, tb, nb = new Jl, eb = 1e-6, rb = 1e-12, ib = Math.PI, ob = ib / 2, ub = ib / 4, ab = 2 * ib,
        cb = 180 / ib, sb = ib / 180, fb = Math.abs, lb = Math.atan, hb = Math.atan2, pb = Math.cos, db = Math.ceil,
        vb = Math.exp, _b = Math.log, yb = Math.pow, gb = Math.sin, mb = Math.sign || function (t) {
            ...
            point: eh, lineStart: eh, lineEnd: eh, polygonStart: function () {
            ...
            point: mh, lineStart: bh, lineEnd: wh, polygonStart: function () {
            ...
            sphere: eh, point: Ch, lineStart: Ph, lineEnd: Rh, polygonStart: function () {
    ...
    jh.invert = jh;
    var Sb, Ab, Eb, Cb, zb, Pb, qb, Lb, Rb, Ub, Db, Ob, Fb = 1e9, Ib = -Fb,
        Yb = {sphere: eh, point: eh, lineStart: up, lineEnd: eh, polygonStart: eh, polygonEnd: eh}, Bb = [null, null],
        jb = {type: "LineString", coordinates: Bb}, Hb = Gl(), Xb = Gl(), Vb = {
            point: eh, lineStart: eh, lineEnd: eh, polygonStart: function () {
        ...
        }, Wb = 1 / 0, $b = Wb, Zb = -Wb, Gb = Zb, Jb = {
            point: bp, lineStart: eh, lineEnd: eh, polygonStart: eh, polygonEnd: eh, result: function () {
                var t = [[Wb, $b], [Zb, Gb]];
                return Zb = Gb = -($b = Wb = 1 / 0), t
            }
        }, Qb = 0, Kb = 0, tw = 0, nw = 0, ew = 0, rw = 0, iw = 0, ow = 0, uw = 0, aw = {
            point: wp, lineStart: Mp, lineEnd: Np, polygonStart: function () {
